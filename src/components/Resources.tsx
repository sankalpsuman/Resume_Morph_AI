      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20 md:mb-32 text-center">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-7xl lg:text-8xl font-black text-[var(--text-primary)] tracking-tighter mb-4 md:mb-8 leading-[1.1] md:leading-[0.85]"
          >
          ...
          <motion.p 
            ...
            className="text-base md:text-2xl text-[var(--text-secondary)] max-w-3xl mx-auto font-medium leading-relaxed px-4"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 mb-20 md:mb-32">
          {resourceCards.map((card, index) => (
            ...
            >
              ...
              <div className={cn(
                "w-12 h-12 md:w-16 md:h-16 rounded-[20px] md:rounded-[28px] flex items-center justify-center mb-6 md:mb-10 shadow-lg group-hover:scale-110 transition-transform duration-500 shrink-0",
                card.lightColor,
                "dark:bg-opacity-10"
              )}>
                <card.icon className={cn("w-6 h-6 md:w-8 md:h-8", card.textColor)} />
              </div>
              
              <div className="flex-grow flex flex-col">
                <h3 className="text-xl md:text-2xl font-black text-[var(--text-primary)] mb-3 md:mb-4 tracking-tight flex items-center justify-between">
                  {card.title}
                ...
                <p className="text-[var(--text-secondary)] font-medium leading-relaxed mb-6 md:mb-10 text-xs md:text-base">
                  {card.description}
                </p>
                
                <div className="mt-auto flex flex-wrap gap-2">
                  {card.details.map(detail => (
                    <span key={detail} className="px-3 py-1.5 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl text-[8px] md:text-[9px] font-black text-[var(--text-tertiary)] uppercase tracking-widest whitespace-nowrap">
                      {detail}
                    </span>
                  ))}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-20 md:mb-32">
          <div className="lg:col-span-2 space-y-6 md:space-y-8 flex flex-col justify-center">
            <h2 className="text-3xl md:text-4xl font-black text-[var(--text-primary)] tracking-tight leading-tight">Advanced <br />Support Stack.</h2>
          ...
          <div className="lg:col-span-3 p-8 md:p-20 bg-gray-950 rounded-[40px] md:rounded-[64px] relative overflow-hidden group flex flex-col justify-center border border-white/5 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12 text-center md:text-left">
              ...
              <div className="shrink-0 w-40 h-40 md:w-56 md:h-56 bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[40px] md:rounded-[56px] flex items-center justify-center rotate-6 group-hover:rotate-0 transition-transform duration-1000 relative">
                ...
                <Globe className="w-16 h-16 md:w-24 md:h-24 text-indigo-400 opacity-50 relative z-10" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-16 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-[40px] md:rounded-[64px] shadow-sm flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-10 hover:shadow-2xl hover:shadow-indigo-100/50 dark:hover:shadow-none dark:hover:border-indigo-500/50 transition-all border-b-4 border-b-indigo-600">
          <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8 text-center sm:text-left">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl md:rounded-[32px] flex items-center justify-center shadow-sm shrink-0">
              <Star className="w-8 h-8 md:w-10 md:h-10 text-amber-500 fill-amber-500" />
            </div>
            <div>
              <h4 className="text-2xl md:text-3xl font-black text-[var(--text-primary)] tracking-tight mb-2 leading-tight">Need a professional review?</h4>
              <p className="text-[var(--text-secondary)] text-sm md:text-lg font-medium leading-relaxed max-w-xl">Join our community channel and get your resume grade assessed by executive hiring experts.</p>
            </div>
          </div>
          <button 
            onClick={() => onTabChange('feedback')}
            className="w-full lg:w-auto px-8 md:px-12 py-4 md:py-6 bg-indigo-600 text-white rounded-2xl md:rounded-[32px] text-xs md:text-sm font-black uppercase tracking-widest hover:bg-gray-900 transition-all shadow-2xl shadow-indigo-100 whitespace-nowrap active:scale-95"
          >
            Initiate Review
          </button>
        </div>
