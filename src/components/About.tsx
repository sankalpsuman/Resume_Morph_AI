    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans selection:bg-indigo-100 pt-24 md:pt-32 pb-16 md:pb-24">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full">
          <div className="absolute top-20 left-10 w-48 h-48 md:w-64 md:h-64 bg-indigo-200/20 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-20 right-10 w-64 h-64 md:w-96 md:h-96 bg-purple-200/20 rounded-full blur-3xl animate-pulse delay-700" />
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 rounded-full text-indigo-600 text-[10px] md:text-xs font-black uppercase tracking-widest mb-6 md:mb-8">
              <Sparkles className="w-3 h-3" />
              The Future of Career Tech
            </div>
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tighter text-gray-900 mb-6 md:mb-8 leading-[1.1] md:leading-[0.9]">
              Morphing Your <br />
      ...
      {/* Purpose & Features */}
      <section className="py-16 md:py-24 border-y border-gray-100 bg-gray-50/30">
