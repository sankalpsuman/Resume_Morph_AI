    ...
    <div className="bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-indigo-100 py-12 md:py-20 rounded-[32px] md:rounded-[40px] shadow-sm border border-[var(--border-color)] overflow-hidden relative transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          <motion.h1 
            ...
            className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tighter text-[var(--text-primary)] mb-12 leading-[0.9] md:leading-[0.8]"
          >
            Re-architecting <br />
          ...
          <motion.p 
            ...
            className="text-lg md:text-2xl text-[var(--text-secondary)] font-medium max-w-3xl mx-auto leading-relaxed px-4"
          >
      ...
      <section className="py-24 md:py-32 border-y border-[var(--border-color)] bg-[var(--bg-secondary)]">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <motion.div 
              whileHover={{ y: -5 }}
              className="p-10 bg-[var(--bg-primary)] rounded-[40px] shadow-sm border border-[var(--border-color)] group transition-all"
            >
              <div className="w-14 h-14 bg-indigo-600 rounded-2xl shadow-xl shadow-indigo-100 dark:shadow-none flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <Cpu className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-black tracking-tight mb-4 text-[var(--text-primary)]">Style Cloning</h3>
              <p className="text-[var(--text-secondary)] font-medium leading-relaxed text-sm md:text-base">
            ...
            <motion.div 
              ...
              className="p-10 bg-[var(--bg-primary)] rounded-[40px] shadow-sm border border-[var(--border-color)] group transition-all"
            >
              <div className="w-14 h-14 bg-purple-600 rounded-2xl shadow-xl shadow-purple-100 dark:shadow-none flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <Zap className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-black tracking-tight mb-4 text-[var(--text-primary)]">Role Optimization</h3>
              <p className="text-[var(--text-secondary)] font-medium leading-relaxed text-sm md:text-base">
            ...
            <motion.div 
              ...
              className="p-10 bg-[var(--bg-primary)] rounded-[40px] shadow-sm border border-[var(--border-color)] group transition-all"
            >
              <div className="w-14 h-14 bg-emerald-600 rounded-2xl shadow-xl shadow-emerald-100 dark:shadow-none flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                <Shield className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-2xl font-black tracking-tight mb-4 text-[var(--text-primary)]">Data Integrity</h3>
              <p className="text-[var(--text-secondary)] font-medium leading-relaxed text-sm md:text-base">
      ...
      {/* The Story Section */}
      <section className="py-16 md:py-24 overflow-hidden bg-[var(--bg-primary)]">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-4 md:space-y-6 text-[var(--text-secondary)] font-medium text-base md:text-lg leading-relaxed">
                <p>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-[32px] md:rounded-[40px] p-8 md:p-12 space-y-6 md:space-y-8 relative z-10 border border-indigo-100 dark:border-indigo-800">
                ...
                <h3 className="text-xl md:text-2xl font-black tracking-tight text-[var(--text-primary)]">The Technology</h3>
      ...
      <section className="py-16 md:py-24 bg-indigo-50/30 dark:bg-indigo-900/10">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
            ...
            >
              <div className="bg-[var(--bg-primary)] rounded-[40px] p-10 shadow-2xl shadow-indigo-100 dark:shadow-none border border-[var(--border-color)] relative overflow-hidden group">
                ...
                <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-indigo-200 dark:shadow-none">
                  <Rocket className="text-white w-8 h-8" />
                </div>
                <h3 className="text-3xl font-black text-[var(--text-primary)] mb-6 tracking-tight">Beyond the Paper.</h3>
                <p className="text-[var(--text-secondary)] font-medium leading-relaxed mb-8 text-lg">
                ...
                <div className="flex items-center gap-4 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl border border-indigo-100 dark:border-indigo-800">
                  ...
                  <p className="text-sm font-bold text-indigo-900 dark:text-indigo-300">Instantly convert any resume into a premium SaaS-style portfolio.</p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="space-y-8 order-1 md:order-2">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-[var(--text-primary)] leading-[0.9]">
                The Next <br />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
                ...
                <div className="w-full max-w-sm md:max-w-md aspect-square bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-[32px] md:rounded-[48px] border border-white/10 flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-4 md:gap-6">
                    ...
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-black text-white tracking-tighter text-shadow-glow">RESUME</div>
          ...
          <div className="bg-[var(--bg-primary)] rounded-[32px] md:rounded-[48px] p-8 md:p-20 border border-[var(--border-color)] shadow-2xl shadow-indigo-100/20 dark:shadow-none">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-full text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-widest mb-8 border border-indigo-100 dark:border-indigo-800">
                <Layers className="w-3 h-3" />
                System Architecture
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-[var(--text-primary)] tracking-tight mb-8">How it's Built.</h2>
              
              <div className="space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-4">
                    <h4 className="text-lg font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">Frontend Stack</h4>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">Animations</h4>
                    <p className="text-[var(--text-secondary)] font-medium leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-4">
                    <h4 className="text-lg font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">Backend & Database</h4>
                    <p className="text-[var(--text-secondary)] font-medium leading-relaxed">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-lg font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">Hosting & Deployment</h4>
                    <p className="text-[var(--text-secondary)] font-medium leading-relaxed">
                ...
                <div className="p-8 bg-indigo-50 dark:bg-indigo-900/20 rounded-3xl border border-indigo-100 dark:border-indigo-800">
                  <h4 className="text-lg font-black text-indigo-900 dark:text-indigo-300 uppercase tracking-widest mb-4">AI Integration</h4>
                  <p className="text-indigo-900/70 dark:text-indigo-300/70 font-medium leading-relaxed">
