...
export default function AccountModal({ isOpen, onClose, user, userData, onLogout, onUpgrade, onOpenAdmin, onDeleteResume }: AccountModalProps) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl bg-white rounded-[48px] shadow-2xl overflow-hidden border border-gray-100 flex flex-col max-h-[90vh]"
          >
            {/* Header */}
                ...
                {recentResumes.length > 0 ? (
                  <div className="grid gap-4">
                    {recentResumes.map((resume: any) => (
                      <div 
                        key={resume.id}
                        className="group flex flex-col sm:flex-row items-center justify-between p-6 bg-white hover:bg-gray-50/50 rounded-[32px] border border-gray-100 hover:border-indigo-100 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-100/20"
                      >
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto">
                          <button 
                            ...
                            className="flex-grow sm:flex-none flex items-center justify-center gap-2 px-5 py-3 bg-white text-gray-600 font-black text-[10px] uppercase tracking-widest rounded-2xl border border-gray-100 shadow-sm hover:border-indigo-200 hover:text-indigo-600 transition-all active:scale-95"
                          >
                          ...
                          <button 
                            ...
                            className="flex-grow sm:flex-none flex items-center justify-center gap-2 px-5 py-3 bg-indigo-600 text-white font-black text-[10px] uppercase tracking-widest rounded-2xl shadow-lg shadow-indigo-100 hover:shadow-indigo-200 transition-all active:scale-95"
                          >
