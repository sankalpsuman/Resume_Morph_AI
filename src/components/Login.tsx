        ...
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-10">
            <div className="flex items-center gap-3 md:gap-4 justify-center lg:justify-start">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-indigo-600 rounded-xl md:rounded-2xl flex items-center justify-center shadow-2xl shadow-indigo-200 rotate-3 shrink-0">
                <RefreshCw className="text-white w-6 h-6 md:w-8 md:h-8" />
              </div>
              <h1 className="text-2xl md:text-3xl font-black tracking-tighter text-gray-900 leading-none">Resume Morph</h1>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 text-center lg:text-left">
              <motion.h2 
                ...
                className="text-4xl xs:text-5xl md:text-7xl font-black tracking-tighter leading-[0.85] text-gray-900"
              >
            ...
            <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-2 gap-3 md:gap-4 px-2 sm:px-0">
              {[
                { id: 'morphing', icon: Zap, text: "Morph", color: "text-amber-500", bg: "bg-amber-50" },
                { id: 'smart-editor', icon: Sparkles, text: "Smart", color: "text-purple-500", bg: "bg-purple-50" },
                { id: 'portfolio', icon: Globe, text: "Portfolio", color: "text-blue-500", bg: "bg-blue-50" },
                { id: 'ats', icon: ShieldCheck, text: "ATS", color: "text-green-500", bg: "bg-green-50" }
              ].map((feature, i) => (
                <motion.div 
                  key={feature.id}
                  ...
                  className="flex items-center gap-2 md:gap-4 p-3 md:p-5 bg-white rounded-2xl md:rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all sm:justify-start justify-center"
                >
                  <div className={`w-8 h-8 md:w-10 md:h-10 ${feature.bg} rounded-lg md:rounded-xl flex items-center justify-center shrink-0`}>
                    <feature.icon className={`w-4 h-4 md:w-5 md:h-5 ${feature.color}`} />
                  </div>
                  <span className="text-[10px] md:text-sm font-black text-gray-700 uppercase tracking-wider">{feature.text}</span>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <motion.div 
            ...
            className="bg-white rounded-[40px] md:rounded-[48px] p-8 md:p-16 shadow-2xl shadow-indigo-100 border border-gray-50 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 bg-indigo-50 rounded-full -mr-24 -mt-24 md:-mr-32 md:-mt-32 blur-3xl opacity-50" />
            
            <div className="relative z-10 space-y-8 md:space-y-10 text-center">
              <div className="space-y-2 md:space-y-3">
                <h3 className="text-3xl md:text-4xl font-black tracking-tight text-gray-900">Get Started</h3>
                <p className="text-gray-500 font-medium text-base md:text-lg">Sign in to start morphing your resume</p>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 md:gap-4 px-6 md:px-8 py-5 md:py-6 bg-gray-900 text-white rounded-2xl md:rounded-3xl font-black text-xs md:text-sm uppercase tracking-widest hover:bg-black transition-all active:scale-95 shadow-2xl shadow-gray-200 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoggingIn === 'google' ? (
              ...
              <div className="pt-8 md:pt-10 border-t border-gray-100">
                ...
                <p className="text-[8px] md:text-[10px] uppercase tracking-[0.15em] md:tracking-[0.2em] text-gray-400 font-black px-4">
      ...
      <section className="py-16 md:py-24 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10 md:mb-16 space-y-3 md:space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-gray-900 leading-none">Real Feedback. <span className="text-indigo-600">Real Results.</span></h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {feedbacks.map((item, i) => (
              <motion.div
                ...
                className="p-6 md:p-8 bg-gray-50 rounded-[28px] md:rounded-[32px] border border-gray-100 space-y-4 md:space-y-6 hover:bg-white hover:shadow-xl hover:shadow-indigo-50 transition-all duration-500 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-black text-gray-900 text-xs md:text-sm">{item.name}</h4>
                      <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">Verified User</p>
                    </div>
                  </div>
                ...
                <p className="text-sm md:text-gray-600 font-medium leading-relaxed italic line-clamp-4 group-hover:line-clamp-none transition-all">
                  "{item.message}"
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full text-gray-600 text-[10px] font-black uppercase tracking-widest shadow-sm mx-auto md:mx-0">
            ...
            <div className="bg-white p-8 md:p-12 rounded-[40px] md:rounded-[48px] shadow-xl shadow-gray-200 border border-gray-100 space-y-6 md:space-y-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-50 rounded-full -mr-16 -mt-16 blur-3xl opacity-50" />
              
              <div className="flex items-center gap-4 md:gap-6 relative z-10">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-indigo-600 rounded-2xl md:rounded-3xl flex items-center justify-center text-white shadow-xl shadow-indigo-100 shrink-0">
                  <User className="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <div>
                  <h3 className="text-xl md:text-2xl font-black text-gray-900">Sankalp</h3>
                  <p className="text-[10px] md:text-sm text-indigo-600 font-black uppercase tracking-widest">Founder & Creator</p>
                </div>
              </div>

              <div className="space-y-4 md:space-y-6 relative z-10">
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-gray-50 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-50">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-lg text-[8px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest">
