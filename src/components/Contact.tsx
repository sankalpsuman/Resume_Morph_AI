  ...
  return (
    <div className="bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-indigo-100 py-12 md:py-20 rounded-[32px] md:rounded-[40px] shadow-sm border border-[var(--border-color)] overflow-hidden relative transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[-5%] right-[-5%] w-[500px] h-[500px] bg-indigo-50/50 dark:bg-indigo-900/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[20%] left-[-5%] w-[400px] h-[400px] bg-purple-50/50 dark:bg-purple-900/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <div className="text-center space-y-8 md:space-y-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100/50 dark:border-indigo-800 rounded-full text-indigo-600 dark:text-indigo-400 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-4 shadow-sm">
              <Send className="w-4 h-4" />
              Direct Support Channel
            </div>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-[var(--text-primary)] leading-[0.95] md:leading-[0.85]">
              Let's Scale Your <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
            <motion.div 
              whileHover={{ y: -5 }}
              className="p-12 md:p-16 bg-gray-950 dark:bg-gray-900 rounded-[64px] text-white space-y-10 relative overflow-hidden group border border-white/5 shadow-2xl"
            >
            ...
            <motion.div 
              whileHover={{ y: -5 }}
              className="p-12 md:p-16 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-[64px] space-y-10 relative overflow-hidden group shadow-sm hover:shadow-2xl hover:shadow-indigo-100/50 transition-all border-b-4 border-b-indigo-600"
            >
              ...
              <div className="relative z-10 space-y-10">
                <div className="w-16 h-16 bg-indigo-600 rounded-3xl flex items-center justify-center shadow-xl shadow-indigo-100 dark:shadow-none group-hover:scale-110 transition-transform duration-500">
                  <Linkedin className="w-8 h-8 text-white" />
                </div>
                <div className="space-y-6">
                  <h2 className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.2em]">Strategic Partnerships</h2>
                  <h3 className="text-3xl md:text-4xl font-black tracking-tight text-[var(--text-primary)] leading-none">Connect with <br />the Founder</h3>
                ...
                <a 
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-4 px-10 py-5 bg-indigo-600 hover:bg-indigo-700 rounded-[28px] text-white text-sm font-black uppercase tracking-widest transition-all shadow-2xl shadow-indigo-100 dark:shadow-none"
                >
                  LinkedIn Profile
                  <ExternalLink className="w-5 h-5" />
                </a>
